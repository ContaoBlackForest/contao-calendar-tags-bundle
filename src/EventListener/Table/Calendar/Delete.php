...
namespace BlackForest\Contao\Calendar\Tags\EventListener\Table\Calendar;

use Contao\DataContainer;
use Doctrine\DBAL\Connection;

/**
 * This handle if a calendar model delete.
 */
class Delete
{
    /**
    ...
    /**
     * Handle if a calendar model delete.
     *
    ...
    public function handle(DataContainer $container)
    {
        ...
        $queryBuilder
            ...
            ->where($queryBuilder->expr()->eq('r.calendar', ':calendarId'))
            ->setParameter(':calendarId', $container->activeRecord->id);
