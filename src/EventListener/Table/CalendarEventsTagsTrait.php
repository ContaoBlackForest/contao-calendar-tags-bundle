...
namespace BlackForest\Contao\Calendar\Tags\EventListener\Table;
...
/**
 * Trait for table tl_calendar_events_tags and tl_calendar_events_tags_relation.
 */
trait CalendarEventsTagsTrait
{
    /**
     * The backend user.
     *
