...
$GLOBALS['TL_LANG']['FMD']['calendarEventsTagsShow']['show'] = 'Kategorien';

$GLOBALS['TL_LANG']['FMD']['calendarEventsTagsFilter']['filter']      = 'Filter';
$GLOBALS['TL_LANG']['FMD']['calendarEventsTagsFilter']['clearFilter'] = 'Filter löschen';
